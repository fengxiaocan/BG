...
public class Lauar {
    ...
    private static int[] lunarInfo = {0x04bd8,
                                      0x04ae0,
                                      0x0a570,
                                      0x054d5,
                                      0x0d260,
    ...
    private static int[] solarMonth = {31,
                                       28,
                                       31,
                                       30,
                                       31,
    ...
    private static String[] Animals = {"鼠",
                                       "牛",
                                       "虎",
                                       "兔",
                                       "龙",
    ...
    private static int[] sTermInfo = {0,
                                      21208,
                                      42467,
                                      63836,
                                      85337,
    ...
    private static String[] monthNong = {"正",
                                         "正",
                                         "二",
                                         "三",
                                         "四",
    ...
    private static String[] yearName = {"零",
                                        "壹",
                                        "贰",
                                        "叁",
                                        "肆",
    ...
    private static int leapDays(int y) {
        ...
        {
            return ((lunarInfo[y - 1900] & 0x10000) == 0
                    ? 29
                    : 30);
        } else
